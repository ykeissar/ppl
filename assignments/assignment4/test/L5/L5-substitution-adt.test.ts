...
import * as S from "../../L5/L5-substitution-adt";
import { makeTVar, parseTE, unparseTExp, TExp } from "../../L5/TExp";
import { bind, isFailure, safe2, makeOk, safe3 } from '../../shared/result';
...
describe('L5 Substitution ADT', () => {
    describe('makeSub', () => {
        it('returns an error for circular dependencies', () => {
            ...
            expect(sub1).to.satisfy(isFailure);
        });
    });
    ...
    describe('applySub', () => {
        it('applies a substitution on a type expression', () => {
            ...
            expect(unparsed).to.deep.equal(makeOk("(number * boolean -> number)"));
        });
    });
    ...
    describe('combineSub', () => {
        it('combines substitutions (the o operator)', () => {
            ...
            expect(res4).to.deep.equal(expected4);
            ...
            expect(res5).to.deep.equal(expected5);
            ...
            expect(res6).to.deep.equal(expected6);
        });
