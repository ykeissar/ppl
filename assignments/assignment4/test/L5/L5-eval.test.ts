...
import { isVarDecl, isVarRef, parseL5,Exp,parseL5Exp, isLetValuesExp } from '../../L5/L5-ast';
import { evalParse, evalProgram } from '../../L5/L5-eval';
import { makeEmptySExp, makeSymbolSExp } from '../../L5/L5-value';
import { isClosure, makeCompoundSExp } from '../../L5/L5-value';
import { isOk,makeOk, bind, isOkT, isFailure, Result } from '../../shared/result';
...
describe('L5 Eval', () => {
    ...
    it('evaluates "let-values" expressions', () => {
        expect(evalParse('(let-values (((x y)(values 3 6)))(+ x y))')).to.deep.equal(makeOk(9));
    });
